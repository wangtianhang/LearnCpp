...
void ConvertFBXMesh(FbxMesh* fbxMesh, std::vector<Vector3> &vertices, std::vector<Vector3> &normals, std::vector<GLuint> &elements)
{
...
void ConvertFBXMeshToMeshFilter(FbxMesh* fbxMesh, MeshFliter & meshfilter)
{
...
// 	);
	...
	if (isMesh)
	{
		...
		ConvertFBXMeshToMeshFilter(currMesh, meshFilter);
