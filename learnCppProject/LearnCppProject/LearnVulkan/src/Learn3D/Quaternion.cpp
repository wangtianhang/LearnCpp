...
Quaternion Quaternion::AngleAxis(float degress, Vector3 axis)
{
...
void Quaternion::SetEulerAngles(Vector3 euler)
{
...
Vector3 Quaternion::ToEulerRad(Quaternion q)
{
...
void Quaternion::QuaternionToMatrix(Quaternion q, Matrix3x3 & m)
{
...
void Quaternion::MakePositive(Vector3 & euler)
{
...
bool Quaternion::MatrixToEuler(Matrix3x3 matrix, Vector3 & v)
{
...
void Quaternion::SetXYZ(Vector3 xyz)
{
	x = xyz.x;
	y = xyz.y;
	z = xyz.z;
...
void Quaternion::ToAxisAngleRad(Quaternion q, Vector3& axis, float& angle)
{
