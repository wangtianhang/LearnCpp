...
namespace UnityEngine
{
    ...
    /// </summary>
public struct Matrix4x4RightHand
    {
        ...
        public static bool operator ==(Matrix4x4RightHand lhs, Matrix4x4RightHand rhs)
        {
        ...
        public static Matrix4x4RightHand operator *(Matrix4x4RightHand lhs, Matrix4x4RightHand rhs)
        {
        ...
        public static Vector4 operator *(Matrix4x4RightHand lhs, Vector4 v)
        {
        ...
        public static Matrix4x4RightHand identity
        {
            get
            {
                return new Matrix4x4RightHand
        ...
        public static Matrix4x4RightHand zero
        {
            get
            {
                return new Matrix4x4RightHand
        ...
        /// 逆矩阵
        /// </summary>
        public Matrix4x4RightHand inverse
        {
            get
            {
                return Inverse(this);
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public Matrix4x4RightHand transpose
        {
            get
            {
