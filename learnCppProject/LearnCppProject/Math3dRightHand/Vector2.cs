...
namespace UnityEngine
{
    public struct Vector2 : IComparable<Vector2>
    {
        ...
        public static implicit operator Vector2(Vector3RightHand v)
        {
            return new Vector2(v.x, v.y);
        }

        public static implicit operator Vector3RightHand(Vector2 v)
        {
            return new Vector3RightHand(v.x, v.y, 0f);
        }
