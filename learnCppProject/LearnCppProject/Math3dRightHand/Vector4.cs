...
namespace UnityEngine
{
    public struct Vector4
    {
        ...
        public static implicit operator Vector4(Vector3RightHand v)
        {
            return new Vector4(v.x, v.y, v.z, 0f);
        }

        public static implicit operator Vector3RightHand(Vector4 v)
        {
            return new Vector3RightHand(v.x, v.y, v.z);
        }
